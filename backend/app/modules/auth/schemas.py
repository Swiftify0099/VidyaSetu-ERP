...
class LoginRequest(BaseModel):
    ...
    # ── Device Context (privacy-respecting identifiers only) ───
    # High-entropy UUID generated by client (NOT IMEI/MAC/hardware ID)
    ...
    # Location — only when user explicitly grants permission
