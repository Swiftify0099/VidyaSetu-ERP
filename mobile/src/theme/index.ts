...
export const roleAccents = {
  ...
  transport_incharge: { primary: palette.amber600,  light: palette.amber50,   gradient: [palette.amber500,  palette.amber700]  as string[] },
  exam_coordinator:   { primary: palette.indigo600, light: palette.indigo50,  gradient: [palette.indigo600, palette.indigo800] as string[] },
  ...
  support_staff:      { primary: palette.cyan600,   light: '#ecfeff',         gradient: [palette.cyan500,   palette.cyan600]   as string[] },
